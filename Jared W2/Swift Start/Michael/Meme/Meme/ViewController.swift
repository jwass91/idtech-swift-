...
class ViewController: UIViewController, UIPopoverPresentationControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        @IBAction func shareFacebook(sender: UIButton) {
            if SLComposeViewController.isAvailableForServiceType(SLServiceTypeFacebook){
                ...
                if (fetchResult.lastObject != nil) {
                    ...
                    PHImageManager.defaultManager().requestImageForAsset(lastAsset, targetSize: self.view.bounds.size, contentMode: PHImageContentMode.AspectFill, options: PHImageRequestOptions(), resultHandler: { (result, info) -> Void in
                        
                        var image = self.takeScreenshot()
    ...
    @IBAction func ShareTwitter(sender: UIButton) {
        if SLComposeViewController.isAvailableForServiceType(SLServiceTypeTwitter){
            ...
            Sheet.setInitialText("Share on Twitter")
            Sheet.addImage(takeScreenshot())
